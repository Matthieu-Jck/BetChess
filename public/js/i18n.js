...
const dictionaries = {
  ...
  fr: {
    ...
    "brand.kicker": "Pas d'argent en jeu. Juste des échecs avec un twist.",
    "header.rules": "Règles",
  ...
  de: {
    ...
    "brand.kicker": "Kein Geld im Spiel. Nur Schach mit einem Twist.",
    "header.rules": "Regeln",
  ...
  es: {
    ...
    "brand.kicker": "Sin dinero de por medio. Solo ajedrez con un giro.",
    "header.rules": "Reglas",
  ...
  it: {
    ...
    "brand.kicker": "Niente soldi in gioco. Solo scacchi con una svolta.",
    "header.rules": "Regole",
  ...
  zh: {
    ...
    "language.label": "语言",
    "brand.kicker": "不涉及金钱。只是带点变化的国际象棋。",
    "header.rules": "规则",
    "header.players": "玩家",
    "game.surrender": "认输",
    "timer.opponent": "对手",
  ...
  ja: {
    ...
    "language.label": "言語",
    "brand.kicker": "お金は一切なし。ひとひねりあるチェスです。",
    "header.rules": "ルール",
